...
public:
    ...
    ofVec3d( const ofVec2f& vec );
    ofVec3d( const ofVec4f& vec );
...
inline ofVec3d::ofVec3d( const ofVec2f& vec ):x(vec.x), y(vec.y), z(0) {}
inline ofVec3d::ofVec3d( const ofVec4f& vec ):x(vec.x), y(vec.y), z(vec.z) {}
